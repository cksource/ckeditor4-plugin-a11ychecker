...
define( [ 'quickfix/Base' ], function( Base ) {
	...
	DateUnfold.prototype = new Base();

	DateUnfold.prototype.title = 'Use long date',

	DateUnfold.prototype.descr = 'Automatically replace short dates with the longer versions';
